...
signal rune_slot_changed(slot_index: int, rune_index: int, rune: Rune)
...
func equip_rune(slot_index: int, rune_index: int, rune: Rune) -> Rune:
	...
	emit_signal("rune_slot_changed", slot_index, rune_index, rune)
	return old
...
func unequip_rune(slot_index: int, rune_index: int) -> Rune:
	...
	_rebuild_skill(slot_index)
	emit_signal("rune_slot_changed", slot_index, rune_index, null)
	return old
